...
@Component({
  ...
  templateUrl: './holiday-editcalendar.component.html',
  styleUrls: ['./holiday-editcalendar.component.scss']
})
export class HolidayEditcalendarComponent implements OnChanges {
  @Input() year: number;
  @Input() month: number;
